function [hResp,hDist] = Het2Particle(Trials,D_H,dt,A1,nt,Tar,nTrough1,A2,nTrough2, off)
...
%initialize responses and distortion
   ...
   for tr=1:Trials
       ...
       %particle trajectory
       for j=1:nt-1
           hetPart=mod(hetPart-dt*A1*sin(nTrough1*hetPart-off)-dt*A2*sin(nTrough2*hetPart-off)+sqrt(dt*2*D_H)*randn+pi,2*pi)-pi;     
       end
